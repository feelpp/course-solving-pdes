...
Physical Surface("wall")={917, 182,186,190,194,198,202, 164,144,148,152,156,160, 625,645,641,637,633,629, 683,679,-659,408,-668,-667,695,691,687, 719,715,711,731,727,723, 802, 579,583,587,591, 305, 601,605,609,613, 818,814,810,806, 827,839,835,831};
Physical Surface("inlet")={401};
Physical Surface("solid_outlet")={916};
Physical Surface("gas_outlet")={840};
//Physical Surface("roof")={802};
Physical Volume("internal_volume")={1000};
