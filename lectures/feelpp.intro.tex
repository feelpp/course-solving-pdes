...
\begin{frame}{Projects with Feel++}
  \begin{figure}[H]
    \centering
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/vivabrain.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/eye2brain.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/blood-rheology.png}}\\

    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/hemotumpp.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/optical-tomography.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/hifimagnet.png}}
  \end{figure}
...
\begin{frame}{Projects with Feel++}
  \begin{figure}[H]
    ...
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/chorus.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/holo3.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/mso4sc.png}}\\
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/po.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/bioreactor-sivibirpp.png}}
    \subfigure{\includegraphics[width=.3\linewidth]{figures/applications/gazomat.png}}
...
\begin{frame}{Some remarks about Docker}
  \begin{center}
  \includegraphics[width=.95\linewidth]{figures/feelpp/VMsvsContainers.png}
  \end{center}

\end{frame}
\begin{frame}[fragile,allowframebreaks]{Docker (recommended)}
  % \includegraphics[width=\linewidth]{figures/feelpp/feelpp-docker-pull.png}
    ...
    \begin{tcolorbox}[title=\texttt{feelpp/feelpp-libs},enhanced, watermark
      ...
      \centerline{\mintinline{bash}{docker pull feelpp/feelpp-libs}}
    ...
    \framebreak
      ...
      \centerline{\mintinline{bash}{docker pull feelpp/feelpp-base}}
    ...
    \framebreak
      ...
      \centerline{\mintinline{bash}{docker pull feelpp/feelpp-toolboxes}}
